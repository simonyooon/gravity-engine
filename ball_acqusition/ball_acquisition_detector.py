...
class BallAcquisitionDetector:
    def __init__(self):
        self.ball_acquisition_threshold = 50
        self.min_frames = 11
    ...
    def find_minimum_distance_between_points(self, ball_center, player_bbox):
    ...
    def find_best_candidate_for_possession(self, ball_center, player_tracks_frame, ball_bbox): 
        ...
        for player_id, player_info in player_tracks_frame.items():
            ...
            min_distance = self.find_minimum_distance_between_points(ball_center, player_bbox)
        ...
        if regular_distance_players:
            ...
            if best_candidate[1] < self.ball_acquisition_threshold:
                return best_candidate[0]
